export const forgotPasswordEmailtemplate = (url: string): string => {
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:10px;">
                                                                <div
                                                                    style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:15px;font-weight:400;line-height:150%;text-align:center;mso-line-height-alt:22.5px;">
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        Recibimos una solicitud para restablecer tu
                                                                        contraseña en <strong>DMIT - Facturador
                                                                            online</strong>. Para crear una nueva,</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        class="row-content stack" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f3fafa; color: #000000; width: 640px; margin: 0 auto;"
                                        width="640">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1"
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; word-break: break-word;"><span
                                                                            style="word-break: break-word; color: #2b303a;"><strong>Utiliza
                                                                                éste código</strong></span></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
...
<![endif]--><span class="button" style="background-color: #1aa19c; border-bottom: 0px solid transparent; border-left: 0px solid transparent; border-radius: 60px; border-right: 0px solid transparent; border-top: 0px solid transparent; color: #ffffff; display: inline-block; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; font-size: 18px; font-weight: undefined; mso-border-alt: none; padding-bottom: 15px; padding-top: 15px; padding-left: 30px; padding-right: 30px; text-align: center; width: auto; word-break: keep-all; letter-spacing: normal;"><span
                                                                            style="margin: 0; word-break: break-word; line-height: 36px;"><strong>
                                                                                <a href="${url}">Restablecer contraseña</a></strong></span></span><!--[if mso]></center></v:textbox></v:roundrect><![endif]-->
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="20" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:15px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:left;mso-line-height-alt:22.5px;">
                                                                    <p style="margin: 0; margin-bottom: 2px;">Si no
                                                                        fuiste tú quien solicitó este cambio, ignora
                                                                        este mensaje y tu contraseña permanecerá igual.
                                                                    </p>
                                                                    <p style="margin: 0;">Estamos aquí para ayudarte. Si
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; word-break: break-word;">Este
                                                                        ...
                                                                        través de info@dmit.ar o visita nuestro
                                                                        centro de ayuda en <a
                                                                            href="http://www.dmit.ar">www.dmit.ar</a>;
                                                                        Gracias por confiar
                                                                        en nosotros.</p>
                                                                </div>
                                                            </td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    style="color:#ffffff;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:12px;line-height:120%;text-align:left;mso-line-height-alt:14.399999999999999px;">
                                                                    <p style="margin: 0; word-break: break-word;"><span
                                                                            style="word-break: break-word; color: #ffffff;">DMIT
